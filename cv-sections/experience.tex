...
{ % Description(s) of tasks/responsibilities
    \begin{cvitems}
        \item { Robotic perception engineer focusing on LiDAR systems for real-world autonomous robots. Currently building experience with classical and deep learning-based methods for tasks like semantic segmentation, localization and mapping, and pose-graph optimization. }
    \end{cvitems}
}
