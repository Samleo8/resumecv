...
{ % Description(s) of tasks/responsibilities
	\begin{cvitems}
		\item { Successfully implemented the phase correlation and local pose-graph estimation components of the \fancyref{https://irap.kaist.ac.kr/publications/yspark-2020-icra.pdf}{PhaRaO radar odometry paper} in C++, using the OpenCV and Ceres Solver libraries.}
